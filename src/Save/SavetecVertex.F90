...
!       |________________________________________________________|
         ...
         write(irec,4)'VARIABLES = "xv","yv","zv","ufv","vfv","wfv","pfv","usv","vsv","wsv","psv"'
...
!       |__________________________________| 
         ...
         write(irec,6) (usv(1:N_VERT,k),k=1,NZ-1)
         write(irec,6) (vsv(1:N_VERT,k),k=1,NZ-1)
         write(irec,6) (wsv(1:N_VERT,k),k=1,NZ-1)
         write(irec,6) (psv(1:N_VERT,k),k=1,NZ-1)
!        __________________________________
!       |                                  |
...
!       |__________________________________| 
         ...
         !write(irec,6) (usv_gl(1:N_VERTglobal,k),k=1,NZglobal-1)
         !write(irec,6) (vsv_gl(1:N_VERTglobal,k),k=1,NZglobal-1)
         !write(irec,6) (wsv_gl(1:N_VERTglobal,k),k=1,NZglobal-1)
         !write(irec,6) (psv_gl(1:N_VERTglobal,k),k=1,NZglobal-1)
!        __________________________________
!       |                                  |
!       |  Write interconexions of elements|
!       |__________________________________| 
