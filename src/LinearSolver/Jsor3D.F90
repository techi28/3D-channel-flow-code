...
!---------------------------------------------------------------------!
!      PARTITION JSOR FOR THE SOLUTION OF THE 3D POISSON EQUATION     !
!                            March 2015                               !
!---------------------------------------------------------------------!
!wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww!

      SUBROUTINE Jsor3D(phi,phiv,                    &
                        rhs,Gamx,Gamy,Gamz,          &
...
!    Over-Relaxation technique by blocks (it is Jacobi SOR)           !
!    We use different relaxion factors: relaxSOR. The idea is to      !
!    update each block as the SOR does and later communicate the      !
!    boundary value. This is not the original SOR because in general  !
!    the boundary values of each block should be aready updated when  !
!    it is used.                                                      !
!                                                                     !
!---------------------------------------------------------------------!
!                                                                     !
...
!     ---------------------------------------- 
      integer:: j0,j1,j2,j3,jT,jB,irec,Display
!     ----------------------------------------
...
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#     ifdef KeyDbg
         write(*,'(t15,60a)'), '----> Begin subroutine: JSOR 3D'
#     endif
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!*********************************************************************!
!                                                                     !
!                 Solution of the system (J.S.0.R.) 3D                !
!                                                                     !
!*********************************************************************!
...
!     ________________________________________________________
!     Collect errors (in parallel option)
...
#     ifndef KeyParallel
      ...
      print*,' '
      print*,'        ------------------------------------'
      print*,'        Distribution of the time in JSOR'
      print*,'        ------------------------------------'
...
#     ifdef KeyParallel
      ...
      IF (Display.eq.1) THEN 
      write(*,*), ' '
      write(*,*),'                 Distribution of the time in JSOR'
      write(*,*),'--------------------------------------------------------------------------- '      
...
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#     ifdef KeyDbg
         write(*,'(t15,60a)'), '<---- End   subroutine: JSOR 3D'
#     endif
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
