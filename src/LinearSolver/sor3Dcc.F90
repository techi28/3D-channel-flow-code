...
!---------------------------------------------------------------------!
!                   S.O.R. FOR CELL-CENTER VARIABLES                  !
!                             Oct 2013                                !
!---------------------------------------------------------------------!
!wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww!

      SUBROUTINE SOR3Dcc(phi,                                &
...
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#     ifdef KeyDbg
         write(*,'(t15,60a)'), '----> Begin subroutine: SOR3Dcc'
#     endif
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!     Solution of the system SOR
      ...
      do k=2,NZ-1
         do i=1,N_CELL0
            ...
            jc2 = No_cp(i,2)
            jc3 = No_cp(i,3)
	     residu = Vbm(i,k)-M1(i,k)*phi(jc1,k) &
                              -M2(i,k)*phi(jc2,k) &
                              -M3(i,k)*phi(jc3,k) &
                              -MT(i,k)*phi(i,k+1) &       
                              -MB(i,k)*phi(i,k-1) &
...
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#     ifdef KeyDbg
         write(*,'(t15,60a)'), '<---- End   subroutine:SOR3Dcc'
#     endif
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
